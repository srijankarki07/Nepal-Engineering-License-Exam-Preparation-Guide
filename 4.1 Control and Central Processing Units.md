...
**MCQ Tip:**<br>
Q: _Control memory is part of which unit?_ <br>
→ **Control Unit**
...
**MCQ Tip:**<br>
Microinstruction → stored in **control memory**<br>
...
- “Hardwired control” → **faster execution**<br>
- “Microprogrammed control” → **ease of modification**<br>
...
**MCQ Tip:**<br>
Program Counter (PC) → Holds address of next instruction.<br>
...
**MCQ Tip:**<br>
Immediate addressing → Fastest<br>
...
C. Control Unit<br>
D. Cache Memory<br>
**Answer:** C <br>_It stores microinstructions for control signals._
...
**3.** Hardwired control unit is **\_\_** than a microprogrammed control unit.<br>
A. Slower<br>
B. Faster<br>
C. More flexible<br>
D. Easier to modify<br>
**Answer:** B — _Hardwired is faster but less flexible._
...
C. Memory size<br>
D. Cache size<br>
**Answer:** B <br> _More instructions executed per unit time._
